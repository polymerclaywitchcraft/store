...
const categories = [
  {
    ...
    description:
      'Dear friends, I am ready to work on your ideas and orders. Since I care about ensuring each of you has your own unique piece, I never create exact replicas. However, we can always craft something unique for you inspired by my previous works or bring your specific idea to life.',
  },
  {
    name: 'how-to-order',
          ...
          <div className="max-w-7xl mx-auto px-4 h-full flex items-center">
            <div className="text-center md:text-left">
              ...
              <p className="text-xl mb-8 text-gray-300">
                I create gothic jewellery inspired by dark fairy tales. Crafted
                with magic in every detail and atmosphere
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="relative h-[700px] overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-all">
                  <div className="h-full flex items-center justify-center">
                    ...
                    <p
                      className="text-lg text-gray-300 hidden group-hover:block"
      ...
      <footer className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <a
                    href="https://polymerclaywitchcraft.com/"
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <a
                    href="https://www.facebook.com/share/fA76GzRWFfvrPgW3/"
                    className="hover:text-red-400"
                  >
                    Facebook
                  </a>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Jane / Polymerclay Witchcraft.
              All rights reserved.
            </p>
          </div>
        </div>
